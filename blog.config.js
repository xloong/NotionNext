...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '95b59ea8859b46b38c0158e16e913298',
  ...
  CONTACT_GITHUB: 'https://github.com/xloong', // 你的github个人主页
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '夜火 Blog', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE: './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '关于code的二三事', // 站点描述，被notion中的页面描述覆盖
